...
* Different ways to handle all-pool-members-DOWN situation(fallback): REFUSE, answer with NOERROR and no data in the answer section or any configured end-points.
